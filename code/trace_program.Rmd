...
```{r, echo=FALSE}
path = '../input_files/yeast/yeast_Homo/YBL087C_YER117W_input/save/record.txt'
...
```{r, echo=FALSE}
path = '../input_files/yeast/yeast_Homo/YML026C_YDR450W_input/save/record.txt'
...
```{r, echo=FALSE}
path = '../input_files/test/yeast/yeast_forceTau_Homo/YBL087C_YER117W/save/record.txt'
